...
public class EditSavePhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_camera_edit_photo, container, false);
    }
...
//        Log.d(TAG, "original bitmap width " + bitmap.getWidth() + " height " + bitmap.getHeight());
    ...
    private void pushNewPhotoToGallery(Uri photoUri) {
        DevicePhoto devicePhoto = new DevicePhoto();
        devicePhoto.path = photoUri.getPath();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ...
                pushNewPhotoToGallery(photoUri);
                onCancelClick();
            }
        } else {
