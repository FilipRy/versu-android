...
public class CameraFragment extends AbsPegContentFragment<ICameraViewModel.ICameraViewModelCallback, CameraViewModel> implements SurfaceHolder.Callback, Camera.PictureCallback {
