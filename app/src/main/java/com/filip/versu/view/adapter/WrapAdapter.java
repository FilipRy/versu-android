...
/**
 * All classes in this file are created by: https://github.com/eyeem/RecyclerViewTools
 */
public class WrapAdapter
    ...
    public int getItemCount() {
        if (customView != null) {
            ...
            int sectionCount = 0;
            int maxSectionCount = sections.getSectionCount();
            while (sectionCount < maxSectionCount &&
                    sections.getSectionPosition(sectionCount) <
                            wrapped.getItemCount() + sectionCount) {
                sectionCount++;
            }
            return sectionCount + wrapped.getItemCount() + getHeaderCount() + getFooterCount();
        }
    }
    ...
    static class StaggeredLayoutManagerInternalUtils {
    ...
    static class OnItemClickListenerDetector implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (ignoreExtras && adapter instanceof com.eyeem.recyclerviewtools.adapter.WrapAdapter) {
    ...
    final static class EmptySectionAdapter extends AbstractSectionAdapter {
        @Override
