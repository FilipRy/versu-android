...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private View oldSelection = null; // new field indicating old selected item
    ...
    private void populateTabStrip() {
        ...
        MainViewActivity.MainViewPagerAdapter mainViewPagerAdapter = (MainViewActivity.MainViewPagerAdapter) mViewPager.getAdapter();
        ...
        for (int i = 0; i < mainViewPagerAdapter.getCount(); i++) {
            ...
            tabImageView.setImageResource(mainViewPagerAdapter.getPageIconResID(i));
